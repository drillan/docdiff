...
def export_command(
    ...
    outdated_count = sum(1 for m in result.mappings if m.mapping_type == 'fuzzy' and m.similarity < 0.95)
    ...
    if verbose:
        ...
        console.print(f"  Include outdated: {include_outdated} ({outdated_count} items)")
